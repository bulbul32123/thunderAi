export default function Footer() {
  return (
    <div>
      <footer className="z-layer-1 text-sm flex flex-col lg:gap-19 gap-8 borderColor border-t lg:mt-30 sm:mt-16 mt-12 py-8 black">
        <div className="w-full lg:w-[60rem] grid grid-cols-[1fr] md:grid-cols-[1fr_3fr] lg:grid-cols-[3fr_3fr] mx-auto md:gap-10 gap-6 px-4 sm:px-8 lg:px-0">
          <div className="flex flex-col justify-between ">
            <div className="relative">
              <h5 className="font-bold text-4xl relative text-black">Thunder AI</h5>
            </div>
          ...
          <nav className="grid sm:grid-cols-[1fr_1fr_2fr] grid-cols-1 md:gap-10 gap-6 text-gray-800">
            <section className="text-sm flex flex-col gap-2 text-gray-800">
              <h3>Resources</h3>
              <ul className="gap-3 flex flex-col text-gray-800">
                <li>
                  <a
                    href="https://support.bolt.new"
                    className="text-gray-800 group  hover:text-bolt-elements-textPrimary transition-theme flex items-center gap-1.5"
                    target="_blank"
                  >
                    Support
